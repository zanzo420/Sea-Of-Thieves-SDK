...
{
	unsigned char                                      UnknownData_TMKJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SGDM[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FWindZoneParams
{
	...
	unsigned char                                      UnknownData_CCOZ[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
