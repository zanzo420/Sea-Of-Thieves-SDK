...
{
public:
	unsigned char                                      UnknownData_3ICJ[0x8];                                     // 0x0528(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_EP08[0x4];                                     // 0x0544(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O5CW[0x10];                                    // 0x0668(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ADMQ[0x10];                                    // 0x0698(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L9TH[0x7];                                     // 0x06D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class AActor*                                      TargetActor;                                               // 0x06E0(0x0008) (Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_AW74[0x70];                                    // 0x06E8(0x0070) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_NTZY[0xD0];                                    // 0x0448(0x00D0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_D4LV[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QOB9[0x4E];                                    // 0x008A(0x004E) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JTVF[0x28];                                    // 0x00E8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_G2DQ[0x30];                                    // 0x0520(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_B46I[0x4];                                     // 0x045C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LC7U[0x1];                                     // 0x047F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_90FU[0x7E];                                    // 0x048A(0x007E) MISSED OFFSET (PADDING)
