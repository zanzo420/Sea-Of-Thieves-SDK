...
{
public:
	unsigned char                                      UnknownData_0Y61[0x8];                                     // 0x0288(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_8QE6[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FWwiseNativeEmitterPoolDensityParams        PoolDensityParams;                                         // 0x0040(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData_LWDK[0x18];                                    // 0x0068(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DAZM[0x18];                                    // 0x0080(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LSCB[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_2LRH[0x50];                                    // 0x0038(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4ULL[0xB];                                     // 0x02A5(0x000B) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YPIZ[0xB0];                                    // 0x0028(0x00B0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IJSY[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RZYM[0x8];                                     // 0x0298(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_E2QU[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BXU4[0xC];                                     // 0x0294(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SX82[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WV58[0xA8];                                    // 0x0048(0x00A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZE5O[0x38];                                    // 0x00F8(0x0038) MISSED OFFSET (PADDING)
