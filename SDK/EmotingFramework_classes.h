...
{
public:
	unsigned char                                      UnknownData_RYZ0[0x8];                                     // 0x0428(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_168M[0x110];                                   // 0x0458(0x0110) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_G754[0x118];                                   // 0x0428(0x0118) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JX3H[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
