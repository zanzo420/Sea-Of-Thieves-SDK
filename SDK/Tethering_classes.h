...
{
public:
	unsigned char                                      UnknownData_9H8Q[0x8];                                     // 0x0588(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_S4O4[0x1C];                                    // 0x05A4(0x001C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2NXO[0x4];                                     // 0x05DC(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_X767[0x70];                                    // 0x00C8(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VQ9U[0x5];                                     // 0x014B(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HDXZ[0xF8];                                    // 0x0428(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M4AZ[0x8];                                     // 0x0558(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VCDD[0x3];                                     // 0x0565(0x0003) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6EED[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B8AV[0xD8];                                    // 0x00D8(0x00D8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OOFV[0x2];                                     // 0x01B6(0x0002) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7XM9[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (PADDING)
