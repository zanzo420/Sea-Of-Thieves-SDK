...
void UWwiseObjectPoolWrapperMock::AfterRead()
{
	UWwiseObjectPoolWrapper::AfterRead();

}

void UWwiseObjectPoolWrapperMock::BeforeDelete()
{
	UWwiseObjectPoolWrapper::BeforeDelete();
