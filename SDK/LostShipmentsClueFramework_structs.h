...
struct FRestrictedClueType
{
	...
	unsigned char                                      UnknownData_WEHF[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FEventClueObtained
{
	...
	unsigned char                                      UnknownData_07D4[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FClueSite
{
	...
	unsigned char                                      UnknownData_889V[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FSeaClueCreationChoice
{
	...
	unsigned char                                      UnknownData_HHS6[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
