...
public:
	...
	unsigned char                                      UnknownData_73BG[0x3];                                     // 0x1BC1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_05GW[0x3];                                     // 0x1BC9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
