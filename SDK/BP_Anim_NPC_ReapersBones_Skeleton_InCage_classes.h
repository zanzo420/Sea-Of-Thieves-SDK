...
public:
	...
	unsigned char                                      UnknownData_WU0Z[0x3];                                     // 0x1991(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_98XE[0x3];                                     // 0x1999(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
