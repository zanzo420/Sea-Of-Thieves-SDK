...
public:
	...
	unsigned char                                      UnknownData_UNTU[0x20];                                    // 0x0028(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       DefaultBody;                                               // 0x0060(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_92Z5[0x20];                                    // 0x0060(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	unsigned char                                      UnknownData_AFEB[0x28];                                    // 0x0428(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_210V[0x88];                                    // 0x0468(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IVW3[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3FX3[0x14E];                                   // 0x00EA(0x014E) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7OCO[0x10];                                    // 0x07D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EAC4[0x54];                                    // 0x07FC(0x0054) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5LA9[0x118];                                   // 0x0868(0x0118) MISSED OFFSET (PADDING)
