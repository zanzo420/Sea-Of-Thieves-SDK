...
struct FMemoryVisualiserStat
{
	...
	unsigned char                                      UnknownData_MN6S[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FMemoryVisualiserClass
{
	...
	unsigned char                                      UnknownData_36ZZ[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8C2A[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FMemoryVisualiserCategory
{
	...
	unsigned char                                      UnknownData_HW3X[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2G79[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
