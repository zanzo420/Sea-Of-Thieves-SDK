...
{
	unsigned char                                      UnknownData_8LUB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_E5RE[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_A7AP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
