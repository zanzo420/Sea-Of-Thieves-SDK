...
struct FDamageZoneDamageLevelChanged
{
	...
	unsigned char                                      UnknownData_RSZO[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FHullDamageHit
{
	...
	unsigned char                                      UnknownData_HT5K[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FShipPartLevelsOfDamage
{
	...
	unsigned char                                      UnknownData_XX3Y[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FEventShipDamageApplied
{
	...
	unsigned char                                      UnknownData_NLTW[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
