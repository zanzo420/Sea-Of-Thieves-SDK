...
struct FRowboatDamageEffectData
{
	...
	unsigned char                                      UnknownData_K3A2[0xC];                                     // 0x000C(0x000C) MISSED OFFSET (PADDING)
...
struct FWatercraftRolloverCorrector
{
	...
	unsigned char                                      UnknownData_R9GM[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FOar
{
	...
	unsigned char                                      UnknownData_1IRV[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PU25[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WYBQ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MA35[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FRowboatMountStateTelemetryEvent
{
	...
	unsigned char                                      UnknownData_ZPCF[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FWatercraftDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_ZAQZ[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FScrapeableDamageSpeedEntry
{
	...
	unsigned char                                      UnknownData_LJMP[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
