...
void FEventAIBountySpawnerAdditionalTargetKilled::AfterRead()
{
	READ_PTR_FULL(Instigator, AActor);
}

void FEventAIBountySpawnerAdditionalTargetKilled::BeforeDelete()
{
	DELE_PTR_FULL(Instigator);
}
...
void AFauna::AfterRead()
{
	...
	READ_PTR_FULL(StatusEffectComponent, UStatusEffectComponent);
