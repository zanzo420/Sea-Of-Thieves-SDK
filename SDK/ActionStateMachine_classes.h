...
{
public:
	unsigned char                                      UnknownData_3YUU[0x18];                                    // 0x0428(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UJNI[0x48];                                    // 0x00C8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_70IL[0x768];                                   // 0x0120(0x0768) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HR3A[0x18];                                    // 0x0888(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_C98H[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZL5O[0x10];                                    // 0x0430(0x0010) MISSED OFFSET (PADDING)
