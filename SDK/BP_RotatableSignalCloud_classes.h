...
public:
	...
	class URotateMeshToLocalPlayerComponent*           RotateMeshToLocalPlayer;                                   // 0x04F0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
