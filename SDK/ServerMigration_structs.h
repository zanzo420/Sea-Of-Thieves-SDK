...
struct FServerSettings
{
	...
	unsigned char                                      UnknownData_YPFR[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_XH97[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
struct FServerMigrationSerialisationDetailsTestsUStruct
{
	...
	unsigned char                                      UnknownData_CSNN[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
