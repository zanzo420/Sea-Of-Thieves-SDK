...
struct FReviveEffectsValues
{
	...
	unsigned char                                      UnknownData_0PWS[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Q6FA[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GQML[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FReviveableActionStateConstructionInfo : public FActorActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_UG6S[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J301[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LTYX[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8EMM[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B3XW[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7FXV[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_832Z[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1WEN[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NTL7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GA26[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ODWS[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SZJI[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FRevivingWindowStart
{
	...
	unsigned char                                      UnknownData_WUK4[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FModeSpecificReviveSettings
{
	...
	unsigned char                                      UnknownData_7XU2[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
