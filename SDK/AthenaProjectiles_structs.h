...
struct FThrottledProjectileTickPool
{
	...
	unsigned char                                      UnknownData_WCIP[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGlobalProjectileSettings
{
	...
	unsigned char                                      UnknownData_3D7L[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
