...
{
	unsigned char                                      UnknownData_VC33[0xE0];                                    // 0x0000(0x00E0) MISSED OFFSET (PADDING)
...
struct FPlayerReservation
{
	...
	unsigned char                                      UnknownData_XAZW[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FPartyReservation
{
	...
	unsigned char                                      UnknownData_H3Q3[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
