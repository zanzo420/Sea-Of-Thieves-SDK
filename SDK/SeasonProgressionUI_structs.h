...
struct FNavigationDesc
{
	...
	unsigned char                                      UnknownData_JCEJ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDeedProgressDesc
{
	...
	unsigned char                                      UnknownData_RK82[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSeasonIconPopupAsset
{
	...
	unsigned char                                      UnknownData_JBUO[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FEnableMoreButtonEvent
{
	...
	unsigned char                                      UnknownData_SQUD[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSeasonGoalPopupAsset
{
	...
	unsigned char                                      UnknownData_5DVF[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonNotificationContent
{
	...
	unsigned char                                      UnknownData_MM6U[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FOpenSeasonsMenuEvent
{
	...
	unsigned char                                      UnknownData_Q7GZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       Id;                                                        // 0x0004(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
...
struct FSeasonProgressionUIEventTypeTelemetryFragment
{
	...
	unsigned char                                      UnknownData_JKWL[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonProgressionUITelemetryFragment
{
	...
	unsigned char                                      UnknownData_QNO7[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonsPopupEvent
{
	...
	unsigned char                                      UnknownData_235W[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
