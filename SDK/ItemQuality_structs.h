...
struct FComplexItemQualityEntry
{
	...
	unsigned char                                      UnknownData_NDDJ[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPerComanyItemQualityEntry
{
	...
	unsigned char                                      UnknownData_E6KB[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
