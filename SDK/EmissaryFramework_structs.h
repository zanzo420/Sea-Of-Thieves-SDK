...
struct FEmissaryQuestCompanyActionRewardBoostEvent
{
	...
	unsigned char                                      UnknownData_U5EV[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_B30B[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FEmissaryCompanyActionRewardBoostServiceEvent
{
	...
	unsigned char                                      UnknownData_GOQI[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
