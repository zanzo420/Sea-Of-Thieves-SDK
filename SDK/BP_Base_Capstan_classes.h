...
// 0x0018 (FullSize[0x0818] - InheritedSize[0x0800])
...
public:
	...
	class USphereComponent*                            ProjectileCollision;                                       // 0x0808(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	class UWwiseEmitterComponent*                      NewVar_1;                                                  // 0x0810(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
