...
struct FInAppPurchaseProductRequest
{
	...
	unsigned char                                      UnknownData_F9JM[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FOnlineStoreCatalogItem
{
	...
	unsigned char                                      UnknownData_KPDJ[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAchievementUpdatedEvent
{
	...
	unsigned char                                      UnknownData_6Y8L[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
