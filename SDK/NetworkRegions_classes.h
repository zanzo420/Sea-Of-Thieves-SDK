...
{
public:
	unsigned char                                      UnknownData_31F7[0x90];                                    // 0x0028(0x0090) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_RPFX[0x20];                                    // 0x0448(0x0020) MISSED OFFSET (PADDING)
